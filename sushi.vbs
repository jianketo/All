...
lngMinutes = InputBox("Sushi! Cuanto Tiempo quieres que trabaje por ti" & Replace(Space(5), " ", vbNewLine) & "Enter minutes:", "Awake Duration") 'we are replacing 5 spaces with new lines 
